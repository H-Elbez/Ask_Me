    ...
    <body>
        <div id="navbar" class="navbar">
            <ul class="nav">
                ...
                <a href="includes/logout.inc.php" class="btn btn-primary btn-lg " id="ansQ" role="button">Access Answered Questions</a>
                <li>
                    <h5></h5>
                </li>
            </ul>
        ...
        <div class="container-fluid">
            ...
            while ( $res > 0 ) {
                 echo "<tr>
                           ...
                           "<br data-pg-id='1558'>
                     <div class='col-md-6'>      
                     <a href='includes/output.php?id=",$res["id"],"' class='btn btn-success' role='button' >Answered</a>
                     </div>
                     <div class='col-md-6'>
